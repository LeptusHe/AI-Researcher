...
def extract_novelty(reviews, openai_client, model, seed, client_type=None):
...
if __name__ == "__main__":
    ...
    for filename in tqdm(filenames):
        ...
        try:
            ...
            prompt, response, cost = extract_novelty(reviews, client, args.engine, args.seed, client_type=client_type)
            # print (prompt)
            # print ("\n\n")
            # print (response)
            # print (cost)
